...
<div id="tograypanelmenu">
    ...
    <div class="navirightlink">
        ...
        <div class="welcomename icon-container" title="User Menu" onclick="$('.headerslideright').removeClass('width480');openusermenu();$('.usermenu').show();$('.createnewmenu').hide();$('.showreminders').hide();$('.createnotification').hide();$('.workinghoursstrip').show();">
...
<div class="rnblk">
    ...
    <div class="headerslideright ">
        ...
        <div class="userinformationbox usermenu">
            ...
            <i class="fa fa-times" aria-hidden="true" style="position:absolute; right:15px; top:10px; color:#666666; font-size:18px; cursor:pointer;" onclick="closeusermenu();"></i>


        </div>


        <div class="workinghoursstrip"><i class="fa fa-clock-o" aria-hidden="true"></i> Today's Working Hours: <span class="showcurrentworkinghours">0</span></div>
        ...
        <div class="contnetin usermenu">
            ...
            <?php if ($LoginUserDetails['userType'] == 0) { ?>
                ...
                <?php if ($is_break_scheduled > 0) { ?>
                    <a style="color: orange;" href="javascript:void(0);" id="cancelSchedule" onclick="cancelSchedule('<?php echo $scheduled_result['id']; ?>')"><i class="fa fa-clock-o" aria-hidden="true"></i>
                        &nbsp;Schedule Break</a>
                <?php } else { ?>
                    <a href="javascript:void(0);" id="addBreakSchedule" onclick="loadpop('Schedule Break',this,'400px')" data-toggle="modal" data-target=".bs-example-modal-center" popaction="action=schedulebreak&userid=<?php echo $_SESSION['userid']; ?>&url=<?php echo $actual_link; ?>"><i class="fa fa-clock-o" aria-hidden="true"></i> &nbsp;Schedule Break</a>
                <?php } ?>
            ...
            <a href="#" id="logoffpopup" onclick="loadpop('Are you sure you want to Logout this session: ',this,'600px')" data-toggle="modal" data-target=".bs-example-modal-center" popaction="action=logoffhourspopup&userid=<?php echo $_SESSION['userid']; ?>&username=<?php echo $_SESSION['username']; ?>" style="color:#CC3300;"><i class="fa fa-sign-out" aria-hidden="true"></i> Logout</a>
            ...
            <a href="mailto:info@tripzygo.in" target="_blank" style="color:#333333;"><i class="fa fa-envelope-o" aria-hidden="true"></i> &nbsp;info@tripzygo.in</a>


            <a href="https://www.tripzygo.in" target="_blank" style="color:#333333;"><i class="fa fa-desktop" aria-hidden="true"></i> &nbsp;https://www.tripzygo.in/</a>
        ...
        <div class="contnetin createnewmenu">
            ...
            <div class="mastericons">
                ...
                <?php if ($_SESSION['userid'] == 1) { ?>
                    ...
                    <a href="#" onclick="loadpop('Edit organisation settings',this,'600px')" data-toggle="modal" data-target=".bs-example-modal-center" popaction="action=organisationsettings">


                        <img src="data:image/png;base64," />
                    ...
                    <a href="#" onclick="loadpop('Update default settings',this,'600px')" data-toggle="modal" data-target=".bs-example-modal-center" popaction="action=setlogoandinclusion">
        ...
        <div class="contnetin showreminders">
            ...
            <div class="head17" style="position:relative;">Reminders<i class="fa fa-close" aria-hidden="true" style="position: absolute; right: 0px; top: -5px; color: #666666; font-size: 18px; cursor: pointer;" onclick="closeusermenu();"></i>
            </div>
            ...
            <div class="container-fluid">
                ...
                <div id="navigation">
                    ...
                    <ul class="navigation-menu">
                        ...
                        <?php if ($_SESSION['userid'] != 4060) { ?>
                            <li class="has-submenu"><a href="<?php echo $fullurl; ?>"><i class="dripicons-meter"></i>Dashboard</a>
                            </li>
                        <?php } ?>


                        <?php if (strpos($LoginUserDetails["permissionView"], 'Query') !== false) { ?>
                            <li class="has-submenu<?php if ($selectedmenu == 4) { ?> active<?php } ?>"><a href="display.html?ga=query"><i class="dripicons-archive"></i>Query</a>
                            </li><?php } ?>



                        <?php if (strpos($LoginUserDetails["permissionView"], 'Itinerary') !== false) { ?>
                            <li class="has-submenu<?php if ($selectedmenu == 2) { ?> active<?php } ?>"><a href="display.html?ga=itineraries"><i class="dripicons-briefcase"></i>Itineraries</a>
                            </li><?php } ?>


                        <?php if (strpos($LoginUserDetails["permissionView"], 'Client') !== false) { ?>
                            <li class="has-submenu<?php if ($selectedmenu == 3) { ?> active<?php } ?>"><a href="display.html?ga=clients"><i class="dripicons-user"></i>Clients</a>
                            </li><?php } ?>

                        <?php if ($_SESSION['userid'] != 4060) { ?>
                            <li class="has-submenu<?php if ($selectedmenu == 8) { ?> active<?php } ?>"><a href="display.html?ga=collection"><i class="dripicons-briefcase"></i>Collection </a>
                            </li>
                            <li class="has-submenu<?php if ($selectedmenu == 9) { ?> active<?php } ?>"><a href="display.html?ga=taggings"><i class="dripicons-briefcase"></i>Taggings</a></li>
                        <?php } ?>
                        <?php if ($_SESSION['userid'] == 1) { ?>

                            <li class="has-submenu<?php if ($_REQUEST['ga'] == 'user_city_mapping') { ?> active<?php } ?>">

                                <a href="display.html?ga=user_city_mapping"><i class="dripicons-rocket"></i>User City Mapping</a>
                        ...
                        <?php if ($_SESSION['userid'] == 1 || $_SESSION['userid'] == 4045) { ?>
                            ...
                            <li class="has-submenu<?php if ($_REQUEST['ga'] == 'company-expense') { ?> active<?php } ?>"><a href="display.html?ga=company-expense"><i class="dripicons-export"></i>Expenses</a>
                            </li><?php } ?>
                        ...
                        <?php if (strpos($LoginUserDetails["permissionView"], 'Report') !== false) { ?>
                            <li class="has-submenu" onclick="checkUser()"><a href="#"><i class="dripicons-graph-pie"></i>Reports</a>
                        ...
                        <li><a href="display.html?ga=systemreport">System Report</a></li> -->
                                    ...
                                    <?php if ($_SESSION['userid'] != 4060) { ?>
                                        <li><a href="display.html?ga=cancel_report">Cancel Report</a></li>
                                    ...
                                    //print_r($adminData['roleId']);

                                    if ($clientData['name'] == 'Accounts' ||  $_SESSION['userid'] == 1) { ?>
                        ...
                        <?php if ($_SESSION['userid'] == 1 || $_SESSION['userid'] == 4045 || strpos($LoginUserDetails["permissionView"], 'ManualVoucher') !== false) { ?>
                            ...
                            <li class="has-submenu<?php if ($selectedmenu == 6) { ?> active<?php } ?>"><a style="cursor:pointer;"><i class="fa fa-globe" aria-hidden="true"></i>Marketing</a>
                            ...
                            <?php if ($withwebsite == 'yes') { ?>
                                ...
                                <li class="has-submenu<?php if ($selectedmenu == 6) { ?> active<?php } ?>"><a style="cursor:pointer;"><i class="fa fa-desktop" aria-hidden="true"></i>Website</a>
...
<div class="alert alert-success bg-success text-white headersavealert" role="alert" style=" display:none; <?php if ($_REQUEST['save'] == 3) { ?> display:block;<?php } ?>">Congratulations! Your
    itinerary has been successfully shared
</div>


<div class="alert alert-success bg-success text-white headersavealert" role="alert" style=" display:none; <?php if ($_REQUEST['save'] == 1) { ?> display:block;<?php } ?>">Successfully Save
</div>
...
<?php if ($LoginUserDetails['fromName'] == '' || $LoginUserDetails['emailAccount'] == '' || $LoginUserDetails['emailPassword'] == '' || $LoginUserDetails['smtpServer'] == '' || $LoginUserDetails['emailPort'] == '') { ?>
    ...
    <div class="alert alert-success bg-success text-white" role="alert" style="display: block; background-color: #a7193a !important; margin-top: -58px; text-align: center; position: fixed; width: 100%; border-radius: 0px; padding-top: 22px; padding-bottom: 3px;">
        Please update mail setting! <a href="display.html?ga=mailsetting" style="color:#fff; text-decoration:underline;">Click Here</a></div>
...
<script>
    function checkUser(){
        ...
        //alert(user);
        if(user == 4060){
            window.location.href = 'display.html?ga=attandancesreport';
        }
    }
</script>