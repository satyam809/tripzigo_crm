                        ...
                        <div class="card">
                            <div class="card-body" style="padding:0px;">
                                ...
                                <table class="table table-hover mb-0">
                                    ...
                                    $where1 = '1';
                                    if($_REQUEST['status']){
                                        $where1 = 'paymentStatus='.$_REQUEST['status'];
                                    } else {
                                        $where1 = 'paymentStatus!=0';
                                    }
                                    if($_REQUEST['verify']=='1'){
                                        $where1 .= ' and payment_verified='.$_REQUEST['status'];
                                    } else if($_REQUEST['verify']=='2') {
                                        $where1 .= ' and (payment_verified is NULL or payment_verified=0)';
                                    }
                                    $where1 .= ' and paymentDate > "2023-10-01 00:00:00"';
                                    ...
                                    while($paymentlist=mysqli_fetch_array($rs[0])){
                                        ...
                                        <tr style=" <?php if ($paymentlist['paymentStatus'] == 1) { ?> background-color: #e4fff9;<?php } ?>">
                                            ...
                                            <td align="left" valign="top"
                                                style="text-transform:uppercase;"><?php echo encode($paymentlist['queryId']); ?></td>
                                            ...
                                            <td><?php if($paymentlist['payment_verified']!='1' && ($paymentlist['paymentStatus']=='1' || (date('Y-m-d H:i:s', strtotime($paymentlist['paymentDate'])) < date('Y-m-d H:i:s')))){ ?><label class="switch">
                                                    <input type="checkbox" name="verify" id="verify" onclick="loadpop('Enter OTP',this,'400px')"
                                                           data-toggle="modal" data-target=".bs-example-modal-center"
                                                           popaction="action=addotpreportpgenerate&id=<?php echo $paymentlist['id']?>">
                                                    <span class="slider round"></span>
                                                </label><?php } else if($paymentlist['payment_verified']=='1') { //echo "Verified";?> <div class="tooltip" onclick="loadpop('Enter OTP',this,'400px')"
                                                                                                                                           data-toggle="modal" data-target=".bs-example-modal-center"
                                                                                                                                           popaction="action=addotpreportpgenerate&id=<?php echo $paymentlist['id']?>&unverify=true">Verified<span class="tooltiptext">Click to Unverify</span>
                                                </div> <?php }?></td>
                                            <script>
