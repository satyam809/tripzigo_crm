...
<?php
$n = 1;
$rs = GetPageRecord('*', 'supplierNotes', ' serviceId="' . $serviceId . '" and  queryId="' . $queryId . '" order by id desc');
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="98%" align="left" valign="top" style="padding-left:10px;">
          <div style=" margin-bottom:5px;"><?php echo nl2br(stripslashes($rest['details'])); ?></div>

          <div style=" font-size:12px;"><em><?php echo date('d/m/Y - h:i A', strtotime($rest['dateAdded'])); ?></em> by <?php $rsb = GetPageRecord('*', 'sys_userMaster', ' id="' . $rest['addedBy'] . '"');
...
<?php if ($n == 1) { ?>
  <div style="text-align:center; color:#999999;">No Remark </div>
<?php } ?>