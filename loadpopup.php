    ...
    <form class="custom-validation" action="frmaction.html" target="actoinfrm" novalidate="" method="post"
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-file">
                            ...
                            <input name="oldchangeprofilepic" type="hidden"
                                   ...
                                   value="<?php echo $result['invoiceLogo']; ?>">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="inclusion" rows="5" class="form-control editorclass"

                                  required=""><?php echo stripslashes($result['inclusion']); ?></textarea>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="invoiceTerms" rows="5" class="form-control editorclass"

                                  required=""><?php echo stripslashes($result['invoiceTerms']); ?></textarea>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="packageImportantTips" rows="5" class="form-control editorclass"

                                  required=""><?php echo stripslashes($result['packageImportantTips']); ?></textarea>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input name="leadURL" type="text" class="form-control"
                               ...
                               value="<?php echo stripslashes($result['leadURL']); ?>" required=""/>
        ...
        <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                <input name="paymentAPIKey" type="text" class="form-control" id="paymentAPIKey"

                       value="<?php echo stripslashes($result['paymentAPIKey']); ?>" required=""/>
        ...
        <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                <input name="paymentAPISecret" type="text" class="form-control" id="paymentAPISecret"

                       value="<?php echo stripslashes($result['paymentAPISecret']); ?>" required=""/>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input name="invoiceCompany" type="text" class="form-control" id="invoiceCompany"

                               value="<?php echo stripslashes($result['invoiceCompany']); ?>" required="">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" required="" name="invoiceEmail"

                               value="<?php echo stripslashes($result['invoiceEmail']); ?>">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" required="" name="invoicePhone"

                               value="<?php echo stripslashes($result['invoicePhone']); ?>">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" required="" name="invoiceAddress"

                               value="<?php echo stripslashes($result['invoiceAddress']); ?>">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" required="" name="Invoicegstn"

                               value="<?php echo stripslashes($result['Invoicegstn']); ?>">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" required="" name="invoiceState"

                               value="<?php echo stripslashes($result['invoiceState']); ?>">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" required="" name="invoiceStateCode"

                               value="<?php echo stripslashes($result['invoiceStateCode']); ?>">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" required="" name="manualVoucherPin"

                               value="<?php echo stripslashes($result['manualVoucherPin']); ?>">
...
<?php if ($_REQUEST['action'] == 'addtineraries') {
    ...
    if (isset($_REQUEST['id'])) {
        ...
        $rs_tags_edit = mysqli_query($con, $sql) or die(mysqli_error($con));



        $sql = "select * from  sys_packageBuilder_image where itinerary_id=" . decode($_REQUEST['id']) . " order by id desc ";

        $rs2 = mysqli_query($con, $sql) or die(mysqli_error($con));
    ...
    <form class="custom-validation" id="pressentertosubmitformdisable" action="frmaction.html" target="actoinfrm"
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input name="name" type="text" class="form-control reqfield" id="name"

                               value="<?php echo stripslashes($result['name']); ?>" required="">
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <label for="validationCustom02">Slug

                    </label>

                    

                    <input name="slug" type="text" class="form-control reqfield" id="name" 

                    value="<?php echo stripslashes($result['slug']); ?>" required="" <?php echo ($result['slug'] == '') ? '' : 'readonly'; ?>>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control reqfield" required="" name="startDate" id="startDate"

                               value="<?php if ($_REQUEST['startDate'] != '' && $_REQUEST['startDate'] != '1970-01-01') {
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control reqfield" required="" name="endDate" id="endDate"

                               value="<?php if ($_REQUEST['endDate'] != '' && date('Y', strtotime($_REQUEST['startDate'])) > '1970') {
                ...
                <div class="col-md-2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" min="1" class="form-control reqfield" name="adult"

                               value="<?php if ($_REQUEST['adult'] != '') {
                ...
                <div class="col-md-2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" min="0" class="form-control" name="child"

                               value="<?php if ($_REQUEST['child'] != '') {
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input name="files[]" type="file" class="form-control reqfield" id="files" required="" multiple
                        ...
                        if (isset($_REQUEST['id'])) {
                            ...
                            while ($item = mysqli_fetch_array($rs2)) {
                                ...
                                <div style="float:left;position:relative;margin:5px;"
                                     ...
                                     id="itineraryphoto100<?= $item['id'] ?>">

                                    <span class="dropdown-item neweditpan"

                                          onclick="delete_single_itinerary_photo(<?= $item['id'] ?>);"

                                          style="cursor:pointer;position:absolute;right:-10px; top:-10px;z-index: 1;background-color: #c6e5f5;"><i

                                                class="fa fa-close" aria-hidden="true"></i></span>

                                    <img src="package_image/<?php print_r($item['image_path']); ?>" alt="Snow"
                ...
                <div class="col-md-8">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control reqfield" name="destinations"

                               placeholder="Enter comma separated destinations"

                               value="<?php if ($_REQUEST['destination'] != '') {
                ...
                <div class="col-md-8">
                    ...
                    <div class="form-group">
                        ...
                        <label for="validationCustom02">Relate Key</label>

                        <input type="text" class="form-control reqfield" name="relate_key"

                               placeholder="Enter Relate Key"

                               value="<?php if ($_REQUEST['relate_key'] != '') {

                                   echo trim($_REQUEST['relate_key']);

                               } else {

                                   echo stripslashes($result['relate_key']);
                ...
                <div class="col-md-12">
                 ...
                 <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <label for="validationCustom02">Package Rating</label>

                    <input type="text" name="package_rating" id="package_rating" value="<?php echo stripslashes($result['package_rating']); ?>" class="form-control" />
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="notes" rows="2" class="form-control"
                                  ...
                                  placeholder="Notes"><?php echo stripslashes($result['notes']); ?></textarea>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input name="location" type="text" class="form-control" id="name"

                               value="<?php echo stripslashes($result['location']); ?>" required="">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <label for="validationCustom02">Hotel/Package <i class="fa fa-star-o"></i> Rating

                        </label>

                        <select name="hotel" id="hotel" class="form-control">

                            <option value="0" <?php if ('0' == $result['hotel']) { ?>selected="selected" <?php } ?>>

                                any

                            </option>

                            <option value="1" <?php if ('1' == $result['hotel']) { ?>selected="selected" <?php } ?>>1

                                Star

                            </option>

                            <option value="2" <?php if ('2' == $result['hotel']) { ?>selected="selected" <?php } ?>>2

                                Star

                            </option>

                            <option value="3" <?php if ('3' == $result['hotel']) { ?>selected="selected" <?php } ?>>3

                                Star

                            </option>

                            <option value="4" <?php if ('4' == $result['hotel']) { ?>selected="selected" <?php } ?>>4

                                Star

                            </option>

                            <option value="5" <?php if ('5' == $result['hotel']) { ?>selected="selected" <?php } ?>>5
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="aboutPackage" rows="2" class="form-control"

                                  placeholder="short description"><?php echo stripslashes($result['aboutPackage']); ?></textarea>
                 ...
                 <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <label for="validationCustom02">Website Package Price</label>

                        <input type="number" name="web_pack_price" rows="2" class="form-control" value="<?php echo stripslashes($result['web_pack_price']); ?>"

                                  placeholder="Enter Website Package Price"/>
                 ...
                 <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <label for="validationCustom02">Destination Search</label>

                        <input type="text" name="destination_search" rows="2" class="form-control" value="<?php echo stripslashes($result['destination_search']); ?>"

                                  placeholder="Enter Destination Search value seprated by commas"/>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" rows="2" class="form-control"
                                  ...
                                  placeholder="long description"><?php echo stripslashes($result['description']); ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <select name="destination_type" class="form-control">
                            ...
                            <option value="domestic"
                                    ...
                                    <?php if ('domestic' == $result['destination_type']) { ?>selected="selected" <?php } ?>>
                            ...
                            <option value="international"
                                    ...
                                    <?php if ('international' == $result['destination_type']) { ?>selected="selected" <?php } ?>>
                    ...
                    <div class="form-group">
                        ...
                        <select name="tour_type" class="form-control">
                            ...
                            <option value="honeymoon"
                                    ...
                                    <?php if ('honeymoon' == $result['tour_type']) { ?>selected="selected" <?php } ?>>
                            ...
                            <option value="family"
                                    ...
                                    <?php if ('family' == $result['tour_type']) { ?>selected="selected" <?php } ?>>
                            ...
                            <option value="friends"
                                    ...
                                    <?php if ('friends' == $result['tour_type']) { ?>selected="selected" <?php } ?>>
                            ...
                            <option value="solo"
                                    ...
                                    <?php if ('solo' == $result['tour_type']) { ?>selected="selected" <?php } ?>>Solo

                            </option>

                            <option value="couple"

                                    <?php if ('couple' == $result['tour_type']) { ?>selected="selected" <?php } ?>>
                    ...
                    <div class="form-group">
                        ...
                        <select name="activity_type" class="form-control">
                            ...
                            <option value="adventure"
                                    ...
                                    <?php if ('adventure' == $result['activity_type']) { ?>selected="selected" <?php } ?>>
                            ...
                            <option value="city"
                                    ...
                                    <?php if ('city' == $result['activity_type']) { ?>selected="selected" <?php } ?>>
                            ...
                            <option value="self_drive"
                                    ...
                                    <?php if ('self_drive' == $result['activity_type']) { ?>selected="selected" <?php } ?>>

                                Self Drive

                            </option>

                            <option value="water_activities"

                                    <?php if ('water_activities' == $result['activity_type']) { ?>selected="selected" <?php } ?>>
                            ...
                            <option value="cultural"
                                    ...
                                    <?php if ('cultural' == $result['activity_type']) { ?>selected="selected" <?php } ?>>
                    ...
                    <div class="form-group">
                        ...
                        <select name="landscape_type" class="form-control">
                            ...
                            <option value="beach"
                                    ...
                                    <?php if ('beach' == $result['landscape_type']) { ?>selected="selected" <?php } ?>>
                            ...
                            <option value="mountain"
                                    ...
                                    <?php if ('mountain' == $result['landscape_type']) { ?>selected="selected" <?php } ?>>
                            ...
                            <option value="city"
                                    ...
                                    <?php if ('city' == $result['landscape_type']) { ?>selected="selected" <?php } ?>>
                            ...
                            <option value="country_side"
                                    ...
                                    <?php if ('country_side' == $result['landscape_type']) { ?>selected="selected" <?php } ?>>
                    ...
                    <div class="form-group">
                        ...
                        <select name="publicly_visible" class="form-control">
                            ...
                            <option value=1
                                    ...
                                    <?php if (1 == $result['publicly_visible']) { ?>selected="selected" <?php } ?>>Yes

                            </option>

                            <option value=0

                                    <?php if (0 == $result['publicly_visible'] && $result['publicly_visible'] != "") { ?>selected="selected" <?php } ?>>
                    ...
                    <div class="form-group">
                        ...
                        <select name="website_visible" class="form-control">
                            ...
                            <option value=0
                                    ...
                                    <?php if (0 == $result['website_visible']) { ?>selected="selected" <?php } ?>>No

                            </option>

                            <option value=1

                                    <?php if (1 == $result['website_visible'] && $result['website_visible'] != "") { ?>selected="selected" <?php } ?>>
                ...
                <div class="col-md-8">
                    ...
                    <div class="form-group">
                        ...
                        <label for="validationCustom02">Map URL</label>

                        <input type="text" class="form-control reqfield" name="mapURL"

                               placeholder="Enter Map URL"

                               value="<?php if ($_REQUEST['mapURL'] != '') {

                                   echo trim($_REQUEST['mapURL']);

                               } else {

                                   echo stripslashes($result['mapURL']);
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="keywords" name="keywords" rows="2" class="form-control"

                                  placeholder="Enter Keywords"><?php echo stripslashes($result['keywords']); ?></textarea>
                 ...
                 <div class="col-md-12">
                  ...
                  $selectedValuesString = $result['hotel_facility']; // Example selected values as comma-separated string

                $selectedValues = explode(",", $selectedValuesString); // Split the string into an array

                ?>

                

                <select name="hotel_facility[]" class="js-example-basic-multiple form-control" multiple="multiple">

                    <option value="pac1.webp" <?php if (in_array("pac1.webp", $selectedValues)) echo "selected"; ?>>Hotel</option>

                    <option value="pac5.webp" <?php if (in_array("pac5.webp", $selectedValues)) echo "selected"; ?>>Flight</option>

                    <option value="pac2.webp" <?php if (in_array("pac2.webp", $selectedValues)) echo "selected"; ?>>Meals</option>

                    <option value="pac4.webp" <?php if (in_array("pac4.webp", $selectedValues)) echo "selected"; ?>>Activity</option>

                    <option value="pac3.webp" <?php if (in_array("pac3.webp", $selectedValues)) echo "selected"; ?>>Cab</option>
                    ...
                    <?php if ($_REQUEST['fromquery'] != 1) { ?>
                                ...
                                <select name="packageThemeId" id="packageThemeId" class="form-control">
                                    ...
                                    while ($rest = mysqli_fetch_array($rs)) {
                                        ...
                                        <option value="<?php echo $rest['id']; ?>"
                                                ...
                                                <?php if ($rest['id'] == $result['packageThemeId']) { ?>selected="selected" <?php } ?>><?php echo $rest['name']; ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <select name="showwebsite" id="showwebsite" class="form-control">
                                    ...
                                    <option value="0"
                                            ...
                                            <?php if ('0' == $result['showwebsite']) { ?>selected="selected" <?php } ?>>
                                    ...
                                    <option value="1"
                                            ...
                                            <?php if ('1' == $result['showwebsite']) { ?>selected="selected" <?php } ?>>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input name="websiteCost" type="text" class="form-control reqfield" id="websiteCost"

                                       value="<?php echo stripslashes($result['websiteCost']); ?>">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input name="websiteValidity" type="text" class="form-control reqfield"

                                       id="websiteValidity"

                                       value="<?php if ($_REQUEST['websiteValidity'] != '' && $_REQUEST['websiteValidity'] != '1970-01-01') {
                            ...
                            <div class="form-group">
                                ...
                                <select name="showinPopular" id="showinPopular" class="form-control">
                                    ...
                                    <option value="0"
                                            ...
                                            <?php if ('0' == $result['showinPopular']) { ?>selected="selected" <?php } ?>>
                                    ...
                                    <option value="1"
                                            ...
                                            <?php if ('1' == $result['showinPopular']) { ?>selected="selected" <?php } ?>>
                            ...
                            <div class="form-group">
                                ...
                                <select name="showinSpecial" id="showinSpecial" class="form-control">
                                    ...
                                    <option value="0"
                                            ...
                                            <?php if ('0' == $result['showinSpecial']) { ?>selected="selected" <?php } ?>>
                                    ...
                                    <option value="1"
                                            ...
                                            <?php if ('1' == $result['showinSpecial']) { ?>selected="selected" <?php } ?>>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="aboutPackage" rows="3" class="form-control"

                                          placeholder=""><?php echo stripslashes($result['aboutPackage']); ?></textarea>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input name="name" type="text" class="form-control reqfield" id="name"
                               ...
                               value="<?php echo stripslashes($result['name']);
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input name="location" type="text" class="form-control reqfield" id="location"

                               value="<?php echo stripslashes($result['location']);
                        ...
                        if (isset($_REQUEST['id'])) {
                            ...
                            while ($item = mysqli_fetch_array($rs2)) {
                                ...
                                <div style="float:left;position:relative;margin:5px;"
                                     ...
                                     id="collectionphoto100<?= $item['id'] ?>">

                                    <span class="dropdown-item neweditpan"

                                          onclick="delete_single_photo(<?= $item['id'] ?>);"

                                          style="cursor:pointer;position:absolute;right:-10px; top:-10px;z-index: 1;background-color: #c6e5f5;"><i

                                                class="fa fa-close" aria-hidden="true"></i></span>

                                    <img src="collectionphotos/<?php print_r($item['image_path']); ?>" alt="Snow"
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name='description' rows="2" class="form-control"
                                  ...
                                  placeholder="Description"><?php echo stripslashes($result['description']);
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <select id="itinerary" name="itinerary[]" multiple="multiple" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <select name="location_type" class="form-control">
                            ...
                            <option value="region"
                                    ...
                                    <?php if ('region' == $result['location_type']) { ?>selected="selected" <?php } ?>>
                            ...
                            <option value="country"
                                    ...
                                    <?php if ('country' == $result['location_type']) { ?>selected="selected" <?php } ?>>
                            ...
                            <option value="state"
                                    ...
                                    <?php if ('state' == $result['location_type']) { ?>selected="selected" <?php } ?>>
                            ...
                            <option value="city"
                                    ...
                                    <?php if ('city' == $result['location_type']) { ?>selected="selected" <?php } ?>>
                            ...
                            <option value="place"
                                    ...
                                    <?php if ('place' == $result['location_type']) { ?>selected="selected" <?php } ?>>
...
<?php if ($_REQUEST['action'] == 'addtaggings') {
    ...
    <form class="custom-validation" action="frmaction.html" target="actoinfrm" method="post"
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input list="browsers" name="type" class="form-control reqfield"

                               value="<?php echo stripslashes($result['type']); ?>" required
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select name="destinationName" id="destinationName" class="form-control"
                                ...
                                onchange="loadhotel();" <?php if ($_REQUEST['loaddestinationidload'] != '') { ?> style="pointer-events: none;" <?php } ?>>
                            ...
                            <?php foreach (explode(',', $resultdest['destinations']) as $val) { ?>
                                ...
                                <option value="<?php echo trim($val); ?>"
                                        ...
                                        <?php if ($_REQUEST['loaddestinationidload'] == trim($val)) { ?>selected="selected" <?php } ?>><?php echo $val; ?></option>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select name="pricetype" id="pricetype" class="form-control"
                                ...
                                onchange="changepricetype();" <?php if ($_REQUEST['eventobjectid'] > 0) { ?> style="pointer-events: none;" <?php } ?>>

                            <option value="1" <?php if ($result['hotelType'] == 1) { ?> selected="selected" <?php } ?>>

                                Manual

                            </option>

                            <option value="2" <?php if ($result['hotelType'] == 2 || $_REQUEST['auto'] == 1) { ?> selected="selected" <?php } ?>>
                ...
                <div class="col-md-12 manual">
                    ...
                    <div class="form-group">
                        ...
                        <input name="hotelName" type="text" id="hotelName" class="form-control"
                ...
                <div class="col-md-12 master" style="display:none;">
                    ...
                    <div class="form-group">
                        ...
                        <select name="hotelnamemaster" id="hotelnamemaster" class="form-control"

                                onchange="loadhoteldata();">
                    ...
                    <div class="form-group">
                        ...
                        <select name="hotelCategory" id="hotelCategory" class="form-control">
                            ...
                            <option value="1"
                                    ...
                                    <?php if ($result['hotelCategory'] == 1) { ?>selected="selected" <?php } ?>>1 Star

                            </option>

                            <option value="2"

                                    <?php if ($result['hotelCategory'] == 2) { ?>selected="selected" <?php } ?>>2 Star

                            </option>

                            <option value="3"

                                    <?php if ($result['hotelCategory'] == 3) { ?>selected="selected" <?php } ?>>3 Star

                            </option>

                            <option value="4"

                                    <?php if ($result['hotelCategory'] == 4) { ?>selected="selected" <?php } ?>>4 Star

                            </option>

                            <option value="5"

                                    <?php if ($result['hotelCategory'] == 5) { ?>selected="selected" <?php } ?>>5 Star
                ...
                <div class="col-md-6 manual">
                    ...
                    <div class="form-group">
                        ...
                        <input name="hotelRoom" id="hotelRoommanual" type="text" class="form-control"

                               value="<?php echo stripslashes($result['hotelRoom']); ?>" required="">
                ...
                <div class="col-md-6 manual">
                    ...
                    <div class="form-group">
                        ...
                        <input name="mealPlan" id="mealPlan" type="text" class="form-control manual"

                               value="<?php echo stripslashes($result['mealPlan']); ?>">
                ...
                <div class="row"
                    ...
                    <div style="margin-bottom:10px; width:100%;    padding-left: 10px;"><strong>Enter Number of
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                            ...
                            <input name="singleRoom" type="Number" min="0" class="form-control"

                                   value="<?php echo stripslashes($result['singleRoom']); ?>">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                            ...
                            <input name="doubleRoom" type="Number" min="0" class="form-control"

                                   value="<?php if ($result['doubleRoom'] == '') {
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                            ...
                            <input name="tripleRoom" type="Number" min="0" class="form-control"

                                   value="<?php echo stripslashes($result['tripleRoom']); ?>">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                            ...
                            <input name="quadRoom" type="Number" min="0" class="form-control"

                                   value="<?php echo stripslashes($result['quadRoom']); ?>">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                            ...
                            <input name="cwbRoom" type="Number" min="0" class="form-control"

                                   value="<?php echo stripslashes($result['cwbRoom']); ?>">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                            ...
                            <input name="cnbRoom" type="Number" min="0" class="form-control"

                                   value="<?php echo stripslashes($result['cnbRoom']); ?>">
                ...
                <div class="row"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" required="" name="startDate" id="startDate"
                                   ...
                                   value="<?php echo date('d-m-Y', strtotime($_REQUEST['d'])); ?>">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" required="" name="endDate" id="endDate"

                                   value="<?php if ($result['endDate'] != '') {
                            ...
                            <table border="0" cellpadding="2" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"><input type="checkbox" name="showTime" class="stip1" value="1"
                                                           ...
                                                           <?php if ($result['showTime'] == 1) { ?>checked="checked" <?php } ?>>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" rows="5"
                                  ...
                                  class="editorclass"><?php echo stripslashes($result['description']); ?></textarea>
        ...
        <div class="modal-footer" style=" position:relative;">
            ...
            <?php if ($_REQUEST['id'] != '') { ?>
                ...
                <button type="button" class="btn btn-danger waves-effect waves-light"
                        ...
                        onclick=" dlt('<?php echo $_REQUEST['id']; ?>','<?php echo $_REQUEST['pid']; ?>');"><i
        ...
        <div class="modal-body">
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="transferCategory" id="transferCategory" class="form-control">
                            ...
                            <option value="Private"
                                    ...
                                    <?php if ($result['transferCategory'] == 'Private') { ?>selected="selected" <?php } ?>>
                            ...
                            <option value="SIC"
                                    ...
                                    <?php if ($result['transferCategory'] == 'SIC') { ?>selected="selected" <?php } ?>>
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" id="eventphoto" name="eventPhoto" style="display:none;">
                        ...
                        <select name="destinationName" class="form-control">
                            ...
                            <?php foreach (explode(',', $resultdest['destinations']) as $val) { ?>
                                ...
                                <option value="<?php echo $val; ?>"
                                        ...
                                        <?php if ($result['destinationName'] == $val) { ?>selected="selected" <?php } ?>><?php echo $val; ?></option>
...
<?php if ($_REQUEST['action'] == 'addMeal' && $_REQUEST['pid'] != '' && $_REQUEST['d'] != '') {
    ...
    <form class="custom-validation" action="frmaction.html" target="actoinfrm" novalidate="" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <select name="mealCategory" class="form-control">
                            ...
                            while ($resultdest = mysqli_fetch_array($a)) {
                                ...
                                <option value="<?php echo $resultdest['name']; ?>"

                                        <?php if ($resultdest['name'] == 'Breakfast') { ?>selected="selected" <?php } ?>><?php echo $resultdest['name']; ?></option>
        ...
        <input name="pid" type="hidden" id="editId" value="<?php echo $_REQUEST['pid']; ?>"/><input name="packageDays"

                                                                                                    type="hidden"

                                                                                                    id="packageDays"

                                                                                                    value="<?php echo $_REQUEST['packageDays']; ?>"/>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <input name="flightNo" type="text" class="form-control"

                               value="<?php echo stripslashes($result['flightNo']); ?>" required="">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <input name="fromDestination" type="text" class="form-control"

                               value="<?php echo stripslashes($result['fromDestination']); ?>" required="">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <input name="toDestination" type="text" class="form-control"

                               value="<?php echo stripslashes($result['toDestination']); ?>" required="">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <input name="flightDuration" type="text" class="form-control"

                               value="<?php echo stripslashes($result['flightDuration']); ?>" required="">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" rows="5"
                                  ...
                                  class="form-control"><?php echo stripslashes($result['description']); ?></textarea>
 ...
 <?php } ?>
  ...
  <div class="col-md-12">
     ...
     <div class="form-group">
         ...
         <label for="validationCustom02">Cost Price</label>

         <input name="overall_pricing" type="number" min="0" class="form-control" onkeyup="calculatemarkup();" onchange="calculatemarkup();" id="overall_pricing" value="<?php if($result['overall_pricing']!=''){ echo stripslashes($result['overall_pricing']);  } else { echo '0'; }?>"   >
  ...
  <div class="col-md-12">
     ...
     <div class="form-group">
         ...
         <label for="validationCustom02">Sales</label>

         <input name="sellingPrice" type="number" min="0" class="form-control"  onkeyup="calculatemarkup();" onchange="calculatemarkup();" id="sellingPrice" value="<?php if($result['overall_pricing']!=''){ echo stripslashes($result['overall_pricing']+$result['markupTotal']);  } else { echo '0'; }?>"   >
...
<label for="validationCustom02">Markup</label>
      ...
      <input name="markupTotal" type="number" min="0" class="form-control" id="markupTotal" value="<?php if($result['markupTotal']!=''){ echo stripslashes($result['markupTotal']);  } else { echo '0'; }?>"   >
    ...
    <?php if ($result['sectionType'] != 'Flight') { ?>
        ...
        <div class="col-md-2">
            ...
            <div class="form-group">
                ...
                <input name="international" type="checkbox" min="0" value="true"

                       id="international" <?php if ($result['international_trip'] == 'true') {

                    echo 'checked'; ?><?php } else {
    ...
    <script>
        ...
        function calculatemarkup() {
            ...
            var overall_pricing = Number($('#overall_pricing').val());

            var sellingPrice = Number($('#sellingPrice').val());

            var markup = Math.max(sellingPrice - overall_pricing,0);

            $('#markupTotal').val(markup);
...
<?php if ($_REQUEST['action'] == 'medialibrary' && $_REQUEST['pid'] != '' && $_REQUEST['afunctin'] != '') { ?>
    ...
    <div class="libouterbtn">
        ...
        <a class="active"
           ...
           onclick="$('.libouterbtn a').removeClass('active');$(this).addClass('active');$('#liboutertype').val(1);funloaduploadedphotos(12);"><i

                    class="fa fa-search" aria-hidden="true"></i> &nbsp;Search</a>

        <a onclick="$('.libouterbtn a').removeClass('active');$(this).addClass('active');$('#liboutertype').val(2);funloaduploadedphotos(12);"><i

                    class="fa fa-picture-o" aria-hidden="true"></i> &nbsp;My Uploads</a>
    ...
    <div class="row" style="padding: 0px 10px;">
        ...
        <div class="col-md-9 col-xl-9">
            ...
            <div class="form-group">
                ...
                <input id="keywordsearch" onkeyup="funloaduploadedphotos(12);" name="keywordsearch" type="search"

                       min="0" class="form-control" placeholder="Search" value="">
        ...
        <div class="col-md-3 col-xl-3">
            ...
            <form class="custom-validation" action="frmaction.html" target="actoinfrm" id="upimg" novalidate=""

                  id="uploadmediafrm" method="post" enctype="multipart/form-data">

                <input name="Upload" type="button" value="Upload Photo" id="savingphtobutton"

                       onclick="$('#changeprofilepic').click();"

                       class="btn btn-secondary btn-lg waves-effect waves-light">

                <input name="image[]" multiple id="changeprofilepic" onchange="uploadchk();" type="file"

                       style="display:none;"/> <input name="action" type="hidden" id="action"

                                                      value="uploadphototmedia"/>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input name="daySubject" type="text" class="form-control" id="daySubject"

                               value="<?php echo stripslashes($result['daySubject']); ?>">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="dayDetails" rows="10"

                                  class="form-control"><?php echo stripslashes($result['dayDetails']); ?></textarea>
...
<?php if ($_REQUEST['action'] == 'editDayDetails2' && $_REQUEST['pid'] != '' && $_REQUEST['d'] != '') {
    ...
    <form class="custom-validation" action="frmaction.html" target="actoinfrm" novalidate="" method="post"
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input name="daySubject" type="text" class="form-control" id="daySubject"
                               ...
                               value="<?php if ($_REQUEST['dayitid'] > 0) {
        ...
        <div class="modal-footer" style=" position:relative;">
            ...
            <input name="Save" type="submit" value="Save" id="savingbutton" class="btn btn-primary" data-dismiss="modal"

                   aria-label="Close" onclick="this.form.submit(); this.disabled=true; this.value='Saving...';"
...
<?php if ($_REQUEST['action'] == 'addEditFaq' && isset($_REQUEST['pid']) && !empty($_REQUEST['pid']) &&

(intval($_REQUEST['pid']) > 0)) {



    if(isset($_REQUEST['fid']) && !empty($_REQUEST['fid']) && (intval($_REQUEST['fid']) > 0)){

        $a = GetPageRecord('*', 'sys_packageFAQs', 'id="' . $_REQUEST['fid'] . '"');
    ...
    <form class="custom-validation" action="frmaction.html" target="actoinfrm" novalidate="" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input name="question" type="text" class="form-control" id="question"
                               ...
                               value="<?php if (isset($_REQUEST['fid']) && !empty($_REQUEST['fid']) && (intval($_REQUEST['fid']) > 0)) {
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="answer" name="answer" rows="10" class="form-control"><?php echo (isset

                                ($_REQUEST['fid']) && !empty($_REQUEST['fid']) && (intval($_REQUEST['fid']) > 0)) ?

                                stripslashes($result['description']) : "" ?></textarea>
        ...
        <div class="modal-footer" style=" position:relative;">
            ...
            <input name="action" type="hidden" id="action" value="addEditFaq"/>

            <input name="fid" type="hidden" value="<?php echo $_REQUEST['fid']; ?>"/>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="inclusionExclusion" id="inclusionExclusion" rows="5"

                                  class="editorclass"><?php echo stripslashes($result['inclusionExclusion']); ?></textarea>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="terms" rows="5"
                                  ...
                                  class="editorclass"><?php echo stripslashes($result['terms']); ?></textarea>
            ...
            <input name="baseMarkup" type="number" min="0" class="form-control" value="<?php /*echo stripslashes($result['baseMarkup']); */ ?>" />
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input name="extraMarkup" type="number" min="0" class="form-control"

                               value="<?php echo stripslashes($result['extraMarkup']); ?>"/>
...
<?php if ($_REQUEST['action'] == 'shareitinerary' && $_REQUEST['pid'] != '') {
    ...
    <ul class="nav nav-pills nav-bg-custom nav-justified intab" role="tablist" style=" text-transform:uppercase;">
        ...
        <li class="nav-item" style="text-transform:uppercase;">
            ...
            <a class="nav-link active show" data-toggle="tab" href="#tb1" role="tab" aria-selected="true"><span

                        class="d-none d-md-block">Share privately</span><span class="d-block d-md-none"><i
        ...
        <li class="nav-item">
            ...
            <a class="nav-link" data-toggle="tab" href="#tb2" role="tab" aria-selected="false"><span

                        class="d-none d-md-block">Share publicly</span><span class="d-block d-md-none"><i
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active p-3" id="tb1" role="tabpanel">
            ...
            <p class="font-14 mb-3">Share your itinerary privately via email to specific recipients. Recipients will be

                prompted to create a login in order to view this itinerary.</p>
            ...
            <form class="custom-validation" action="frmaction.html" target="actoinfrm" novalidate="" method="post"
                ...
                <div class="row" style="padding: 0px 6px;  ">
                    ...
                    <div class="col-md-12 col-xl-12">
                        ...
                        <div class="form-group">
                            ...
                            <input id="clientkeywordsearch" onkeyup="loadSearchClients();" type="search"

                                   class="form-control" placeholder="Enter name, email, mobile" value="">
                ...
                <div class="row" style="padding: 0px 6px;">
                    ...
                    <div class="col-md-12 col-xl-12">
                        ...
                        <div class="form-group" style="  border-bottom: 1px solid #dedcdc;">
                            ...
                            <textarea rows="4" class="form-control" name="shareMessage"
                ...
                <div class="modal-footer" style=" position:relative; padding-right:0px;">
                    ...
                    <input name="Save" type="submit" value="Send" id="savingbuttondd"
        ...
        <div class="tab-pane p-3" id="tb2" role="tabpanel">
            ...
            <p class="font-14 mb-3">Activate link to enable the ability to share this itinerary with anyone (no sign-in
                ...
                <tr>
                    ...
                    <td colspan="2">
                        ...
                        <div class="checkbox">
                            ...
                            <form class="custom-validation" action="frmaction.html" id="sharelinkenable"

                                  target="actoinfrm" novalidate="" method="post" enctype="multipart/form-data">

                                <input type="checkbox" name="linkSharing" id="linkSharing" value="1"

                                       <?php if ($result['linkSharing'] == 1) { ?>checked="checked" <?php } ?>
            ...
            <div class="col-md-12 col-xl-12" style="padding:0px;">
                ...
                <a target="_blank"
                   ...
                   href="https://api.whatsapp.com/send?text=<?php echo $fullurlproposal; ?>sharepackage/<?php echo $_REQUEST['pid']; ?>/<?php echo cleanstring(stripslashes($result['name'])); ?>.html&amp;phone=+91<?php echo $resultclient['phone']; ?>"

                   style="position: absolute; right: 0px; top: -4px;">

                    <button type="button" class="btn btn-light btn-sm" style="background-color:#46cd93; color:#fff;"><i

                                class="fa fa-whatsapp" aria-hidden="true"></i> WhatsApp
                ...
                <div class="form-group">
                    ...
                    <input id="clientkeywordsearch" class="form-control" readonly="readonly"

                           value="<?php echo $fullurlproposal; ?>sharepackage/<?php echo $_REQUEST['pid']; ?>/<?php echo cleanstring(stripslashes($result['name'])); ?>.html">
            ...
            <div class="col-md-12 col-xl-12" style="padding:0px;">
                ...
                <a target="_blank"
                   ...
                   href="https://api.whatsapp.com/send?text=<?php echo $fullurlproposal; ?>share/<?php echo $_REQUEST['pid']; ?>/<?php echo cleanstring(stripslashes($result['name'])); ?>.html&amp;phone=+91<?php echo $resultclient['phone']; ?>"
                ...
                <div class="form-group">
                    ...
                    <input id="clientkeywordsearch" class="form-control" readonly="readonly"
                           ...
                           value="<?php echo $fullurlproposal; ?>share/<?php echo $_REQUEST['pid']; ?>/<?php echo cleanstring(stripslashes($result['name'])); ?>.html">
...
<?php if ($_REQUEST['action'] == 'addclient') {
    ...
    <form class="custom-validation" action="frmaction.html" target="actoinfrm" novalidate="" method="post"
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="submitName" class="form-control">
                            ...
                            <option value="Mr."
                                    ...
                                    <?php if ($result['submitName'] == 'Mr.') { ?>selected="selected" <?php } ?>>Mr.

                            </option>

                            <option value="Mrs."

                                    <?php if ($result['submitName'] == 'Mrs.') { ?>selected="selected" <?php } ?>>Mrs.

                            </option>

                            <option value="Ms."

                                    <?php if ($result['submitName'] == 'Ms.') { ?>selected="selected" <?php } ?>>Ms.

                            </option>

                            <option value="Dr."

                                    <?php if ($result['submitName'] == 'Dr.') { ?>selected="selected" <?php } ?>>Dr.

                            </option>

                            <option value="Prof."

                                    <?php if ($result['submitName'] == 'Prof.') { ?>selected="selected" <?php } ?>>Prof.
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control reqfield" required="" name="firstName"
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control reqfield" required="" name="lastName"
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control reqfield" required="" name="email"
                    ...
                    <div class="form-group">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="groupfields">
                            ...
                            <tr>
                                ...
                                <td colspan="2"><input type="text" placeholder="+91" class="form-control" required=""

                                                       name="mobileCode"

                                                       value="<?php echo stripslashes($result['mobileCode']); ?>"

                                                       style="    width:67px !important; margin-right:5px;"></td>

                                <td><input type="text" class="form-control" required="" name="mobile"

                                           value="<?php echo stripslashes($result['mobile']); ?>"
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" required="" name="email2"
                               ...
                               value="<?php echo stripslashes($result['email2']); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="groupfields">
                            ...
                            <tr>
                                ...
                                <td colspan="2"><input type="text" class="form-control" placeholder="+91" required=""

                                                       name="mobileCode2"

                                                       value="<?php echo stripslashes($result['mobileCode2']); ?>"

                                                       style="    width:67px !important; margin-right:5px;"></td>

                                <td><input type="text" class="form-control" required="" name="mobile2"

                                           value="<?php echo stripslashes($result['mobile2']); ?>"
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control reqfield"
                               ...
                               value="<?php echo getCityName($result['city']); ?>" autocomplete="off">

                        <input name="city" id="pickupCity" type="hidden"

                               value="<?php echo stripslashes($result['city']); ?>"/>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="address"
                               ...
                               value="<?php echo stripslashes($result['address']); ?>">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="dob" id="dob"
                               ...
                               value="<?php if (date('d-m-Y', strtotime($result['dob'])) > '01-01-1970' && date('d-m-Y', strtotime($result['dob'])) != '30-11--0001') {
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="marriageAnniversary" id="marriageAnniversary"

                               value="<?php if (date('d-m-Y', strtotime($result['marriageAnniversary'])) > '01-01-1970') {
        ...
        <div class="modal-footer"><input name="Cancel" type="submit" value="Cancel" data-dismiss="modal"
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" required="" name="title"
                               ...
                               value="<?php echo stripslashes($result['title']); ?>">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" rows="6" class="form-control"
                                  ...
                                  required=""><?php echo stripslashes($result['description']); ?></textarea>
                ...
                <div class="col-md-12" style="display:none;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" required="" name="iconset"

                               value="<?php echo stripslashes($result['iconset']); ?>">

                    </div>

                </div>

                <div style="font:12px; display:none;">Pick icon from <a href="https://fontawesome.com/v4.7.0/icons/" target="_blank">https://fontawesome.com/v4.7.0/icons/</a>
...
<?php if ($_REQUEST['action'] == 'showquerymail' && $_REQUEST['id'] != '') {
    ...
    <div class="media mb-4"
         ...
         style="margin-bottom: 10px !important; padding-bottom: 10px; border-bottom: 1px solid #dedede;">
        ...
        <div class="media-body">
            ...
            <small class="text-muted"
                   ...
                   style="font-size: 13px;"><?php echo $displayDataUser['toEmail']; ?></small><?php if ($displayDataUser['ccEmail'] != '') { ?> |

                <small class="text-muted" style="font-size: 13px;">

                CC: <?php echo $displayDataUser['ccEmail']; ?></small><?php } ?>





            <a href="#" title="Reply Mail"

               popaction="action=composemail&queryId=<?php echo $_REQUEST['queryId']; ?>&mailid=<?php echo $_REQUEST['id']; ?>&ac=reply"

               onclick="loadpop('Reply Mail',this,'900px')"><i class="mdi mdi-reply"

                                                               style=" position: absolute; right: 20px; font-size: 20px; top: 22px;"></i></a>
    ...
    <a href="#"
       ...
       onclick="loadpop('Reply Mail',this,'900px')" class="btn btn-secondary waves-effect mt-4"><i
        ...
        <div class="row spdiv">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="reply_to"

                           value="<?php echo $LoginUserDetails['email']; ?>"
            ...
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <textarea name="EmailDetails" rows="10" class="summernote"
                              ...
                              id="EmailDetails"><?php echo $voucherdata; ?><?php if ($_REQUEST['mailid'] != '') { ?>

                    <br/><br/><br/><br/><div

                                style="padding-left:10px; margin-left:10px; border-left:1px solid #ddd;"><?php echo strip($MailData['details']);
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control reqfield" required="" name="company"

                               value="<?php echo stripslashes($result['company']); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="groupfields">
                            ...
                            <tr>
                                ...
                                <td colspan="2"><input type="text" class="form-control" required="" name="mobileCode"

                                                       value="<?php echo stripslashes($result['mobileCode']); ?>"

                                                       style="width: 78px !important;" placeholder="+91"></td>

                                <td><input type="text" class="form-control reqfield" required="" name="mobile"
...
<?php if ($_REQUEST['action'] == 'schedulepayment') {
    ...
    $rs13ddd = GetPageRecord('*', 'sys_packageBuilderEvent', '  packageId="' . decode($_REQUEST['packageId']) . '" order by  supplierCancellationDate desc');
    ...
    <form class="custom-validation" action="frmaction.html" target="actoinfrm" novalidate="" method="post"
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input name="amount" type="number" class="form-control" id="name"

                               value="<?php if ($_REQUEST['id'] != '') {
                        ...
                        <select name="status" id="paymentStatus" class="form-control" onchange="funpaid();">
                            ...
                            <?php if ($_REQUEST['id'] != '') { ?>
                                ...
                                <option value="1"
                                        ...
                                        <?php if ($result['paymentStatus'] == 1) { ?>selected="selected" <?php } ?>>Verify
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="remark" rows="2"
                                  ...
                                  class="form-control"><?php echo stripslashes($result['remark']); ?></textarea>
                ...
                <div class="col-md-12 paid"
                     ...
                     style=" <?php if ($result['paymentStatus'] == 2) { ?> display:none; <?php } ?> <?php if ($_REQUEST['addpay'] == 1) { ?>display:none;<?php } ?>">

                    <div class="form-group">

                        <label for="validationCustom02">Payment Type*</label>

                        <select name="transectionType" id="transectionType" class="form-control"

                                onchange="getreceipt();">

                            <option value="Cash"

                                    <?php if ($result['transectionType'] == 'Cash') { ?>selected="selected" <?php } ?>>
                            ...
                            <option value="Cheque"
                                    ...
                                    <?php if ($result['transectionType'] == 'Checks') { ?>selected="selected" <?php } ?>>
                            ...
                            <option value="NEFT"
                                    ...
                                    <?php if ($result['transectionType'] == 'NEFT') { ?>selected="selected" <?php } ?>>
                            ...
                            <option value="Mobile&nbsp;Payment"
                                    ...
                                    <?php if ($result['transectionType'] == 'Mobile&nbsp;Payment') { ?>selected="selected" <?php } ?>>
                            ...
                            <option value="Payzapp"
                                    ...
                                    <?php if ($result['transectionType'] == 'Payzapp') { ?>selected="selected" <?php } ?>>
                            ...
                            <option value="Razorpay"
                                    ...
                                    <?php if ($result['transectionType'] == 'Razorpay') { ?>selected="selected" <?php } ?>>
                            ...
                            <option value="Paypal"
                                    ...
                                    <?php if ($result['transectionType'] == 'Paypal') { ?>selected="selected" <?php } ?>>
                            ...
                            <option value="Payu"
                                    ...
                                    <?php if ($result['transectionType'] == 'Payu') { ?>selected="selected" <?php } ?>>
                            ...
                            <option value="UPI"
                                    ...
                                    <?php if ($result['transectionType'] == 'UPI') { ?>selected="selected" <?php } ?>>
                            ...
                            <option value="IMPS"
                                    ...
                                    <?php if ($result['transectionType'] == 'IMPS') { ?>selected="selected" <?php } ?>>
                ...
                <div class="col-md-12 receiptfield"
                ...
                <div class="col-md-12 paid trans"
                    ...
                    <div class="form-group">
                        ...
                        <input name="paymentId" type="text" class="form-control"

                               value="<?php echo stripslashes($result['paymentId']); ?>" required="">
        ...
        <?php if(!$_REQUEST['queryId']){
            ...
            $_REQUEST['queryId']=$result['queryId'];

            $_REQUEST['packageId']=$result['packageId'];
        ...
        <input name="redirect" type="hidden" value="<?php echo $_REQUEST['redirect']; ?>"/>
...
<?php if ($_REQUEST['action'] == 'viewinvoice') {
    ...
    <div class="modal-footer">
        ...
        <a href="actionpage.php?action=sendInvoicemail&id=<?php echo $_REQUEST['id']; ?>&queryId=<?php echo $_REQUEST['queryId']; ?>&packageId=<?php echo $_REQUEST['packageId']; ?>"

           target="actoinfrm" id="savingbutton" class="btn btn-primary">Send Mail</a>
...
<?php if ($_REQUEST['action'] == 'viewvoucher') {
    ...
    <div class="modal-footer">
        ...
        <a style="cursor:pointer; color:#FFFFFF;" class="btn btn-primary"

           popaction="action=composemail&queryId=<?php echo $_REQUEST['queryId']; ?>&voucherid=<?php echo($_REQUEST['id']); ?>"

           onclick="loadpop('Compose Mail',this,'900px')">Send Mail</a>
...
<?php if ($_REQUEST['action'] == 'schedulepaymentPlan') {
    ...
    <form class="custom-validation" action="frmaction.html" target="actoinfrm" novalidate="" method="post"
        ...
        <div class="modal-footer">
            ...
            <input name="Save" type="submit" value="Create" id="savingbutton" class="btn btn-primary"
...
<?php if ($_REQUEST['action'] == 'importFBleads') {
    ...
    <form class="custom-validation" action="frmaction.html" target="actoinfrm" novalidate="" method="post"
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="importfield" class="form-control" style="padding: 4px;"
        ...
        <div class="modal-footer">
            ...
            <input name="Save" type="submit" value="Import" id="savingbutton" class="btn btn-primary"
...
<?php if ($_REQUEST['action'] == 'viewmanualvoucher') {
    ...
    <div class="modal-footer">
        ...
        <a style="cursor:pointer; color:#FFFFFF;" class="btn btn-primary"
           ...
           popaction="action=composemailmanualvoucher&voucherid=<?php echo($_REQUEST['id']); ?>"
...
<?php if ($_REQUEST['action'] == 'composemailmanualvoucher' && $_REQUEST['voucherid'] != '') {
    ...
    <form class="custom-validation" action="frmaction.html" id="composemailfrm" target="actoinfrm" novalidate=""
        ...
        <div style="margin-bottom:20px; color:#000; font-size:13px;"><span
                    ...
                    style="color:#999999;">From</span> <?php echo $LoginUserDetails['emailAccount']; ?></div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control reqfield" required="" name="name"
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" id="ff" class="form-control">
                            ...
                            <option value="1" <?php if ($result['status'] == 1) { ?>selected="selected" <?php } ?>>

                                Active

                            </option>

                            <option value="2" <?php if ($result['status'] == 2) { ?>selected="selected" <?php } ?>>
                    ...
                    <div class="form-group">
                        ...
                        <select name="gender" class="form-control">
                            ...
                            <option value="Male"
                                    ...
                                    <?php if ($result['submitName'] == 'Male') { ?>selected="selected" <?php } ?>>Male

                            </option>

                            <option value="Female"

                                    <?php if ($result['submitName'] == 'Female') { ?>selected="selected" <?php } ?>>
                            ...
                            <option value="Other"
                                    ...
                                    <?php if ($result['submitName'] == 'Other') { ?>selected="selected" <?php } ?>>Other
...
<?php if ($_REQUEST['action'] == 'addGuestDocuments') {
    ...
    <form class="custom-validation" action="frmaction.html" target="actoinfrm" novalidate="" method="post"
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td width="55%" align="center"><?php $n = 0;
                            ...
                            while ($result = mysqli_fetch_array($a)) { ?><a

                                href="<?php echo $fullurl; ?>profilepic/<?php echo $result['document']; ?>"

                                class="btn btn-info btn-sm waves-effect waves-light" style="margin: 3px;"

                                target="_blank"><?php //echo ++$n;
                        ...
                        <td>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" name="passportFront" id="passportFront"
                        ...
                        <td>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" name="passportBack" id="passportBack"
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" name="flight[]" multiple id="flight"
                        ...
                        <td align="center"><?php $n = 0;
                            ...
                            while ($result = mysqli_fetch_array($a)) { ?><a
                                ...
                                target="_blank"><?php echo ++$n; ?> Download Flight</a><?php } ?></td>
        ...
        <div class="modal-footer">
            ...
            <input name="Save" type="submit" value="Upload Documents" id="savingbutton" class="btn btn-primary"
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="remark" rows="2" class="form-control" id="remark" required=""
                ...
                <div class="col-md-2">
                    ...
                    <div class="form-group">
                        ...
                        <input name="Save" type="submit" value="Submit" id="savingbutton" class="btn btn-primary"

                               onclick="this.form.submit(); this.disabled=true; this.value='Saving...';$('#remark').val('');"
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" required="" name="rate"
                               ...
                               value="<?php echo stripslashes($result['rate']); ?>">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="form-group">
                                ...
                                <select id="supplierId" name="supplierId" class="select2 form-control"

                                        autocomplete="off" style=" font-size:12px; width: 160px;">
                                    ...
                                    while ($restsup = mysqli_fetch_array($rs2)) {
                                        ...
                                        <option value="<?php echo $restsup['id']; ?>"

                                                <?php if ($restsup['id'] == $rest['supplierId']) { ?>selected="selected" <?php } ?>><?php echo $restsup['company']; ?></option>
                        ...
                        <td>
                            ...
                            <div class="form-group">
                                ...
                                <label for="validationCustom02">Booking&nbsp;Status<span class="redmtext">*</span>

                                </label>

                                <select id="bookingStatusId" name="bookingStatusId" class="select2 form-control"

                                        onchange="calculateAmt();" autocomplete="off"

                                        style="font-size: 12px; padding-right: 0px; padding-left: 4px; color:#fff; background-color:#<?php if ($rest['bookingStatusId'] == 0) { ?>e77350<?php } ?><?php if ($rest['bookingStatusId'] == 1) { ?>e3445a<?php } ?><?php if ($rest['bookingStatusId'] == 2) { ?>01c875<?php } ?><?php if ($rest['bookingStatusId'] == 3) { ?>a55cd9<?php } ?><?php if ($rest['bookingStatusId'] == 4) { ?>323232<?php } ?>;">

                                    <option value="0"

                                            <?php if ($rest['bookingStatusId'] == 0) { ?>selected="selected" <?php } ?>>
                                    ...
                                    <option value="1"
                                            ...
                                            <?php if ($rest['bookingStatusId'] == 1) { ?>selected="selected" <?php } ?>>
                                    ...
                                    <option value="2"
                                            ...
                                            <?php if ($rest['bookingStatusId'] == 2) { ?>selected="selected" <?php } ?>>
                                    ...
                                    <option value="3"
                                            ...
                                            <?php if ($rest['bookingStatusId'] == 3) { ?>selected="selected" <?php } ?>>
                                    ...
                                    <option value="4"
                                            ...
                                            <?php if ($rest['bookingStatusId'] == 4) { ?>selected="selected" <?php } ?>>
                        ...
                        <td class="confno" <?php if ($rest['bookingStatusId'] != 2) { ?> style="display:none;" <?php } ?>>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="confirmationNo" id="confirmationNo"

                                       value="<?php echo $rest['confirmationNo']; ?>" placeholder="Confirmation No"/>
                        ...
                        <td>
                            ...
                            <div class="form-group">
                                ...
                                <label for="validationCustom02">Payment&nbsp;Status<span class="redmtext">*</span>

                                </label>

                                <select id="statusId" name="statusId" class="select2 form-control" autocomplete="off"

                                        style="font-size: 12px; padding-right: 0px; padding-left: 4px; color:#fff; background-color:#<?php if ($rest['status'] == 0) { ?>e77350<?php } ?><?php if ($rest['status'] == 1) { ?>01c875<?php } ?>;">

                                    <option value="0"

                                            <?php if ($rest['status'] == 0) { ?>selected="selected" <?php } ?>>Payment
                                    ...
                                    <option value="1"
                                            ...
                                            <?php if ($rest['status'] == 1) { ?>selected="selected" <?php } ?>>Amount
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="form-group">
                                ...
                                <input name="dueDate" type="text" class="form-control supplierduedate"

                                       readonly="readonly" id="dueDate"

                                       style=" text-align:center; background-color:transparent; font-size:12px; <?php if ($rest['dueDate'] != '' && date('d-m-Y', strtotime($rest['dueDate'])) != '01-01-1970' && $rest['dueDate'] < date('Y-m-d')) { ?>border:1px solid #FF0000;<?php } ?>"

                                       value="<?php if ($rest['dueDate'] != '' && date('d-m-Y', strtotime($rest['dueDate'])) != '01-01-1970') {
                        ...
                        <td>
                            ...
                            <div class="form-group">
                                ...
                                <input name="suppliercancellationdate" type="text"

                                       class="form-control suppliercancellationdate" readonly="readonly" id="startDate"

                                       style=" text-align:center; background-color:transparent; font-size:12px; <?php if ($rest['dueDate'] != '' && date('d-m-Y', strtotime($rest['dueDate'])) != '01-01-1970' && $rest['dueDate'] < date('Y-m-d')) { ?>border:1px solid #FF0000;<?php } ?>"

                                       value="<?php if ($rest['supplierCancellationDate'] != '' && date('d-m-Y', strtotime($rest['supplierCancellationDate'])) != '01-01-1970') {
                        ...
                        <td>
                            ...
                            <div class="form-group">
                                ...
                                <label for="validationCustom02">Supplier&nbsp;Amount<span class="redmtext">*</span>

                                </label>

                                <input type="number" min="0" class="form-control datepick" name="supplierAmount"

                                       id="supplierAmount"

                                       style=" text-align:center; background-color:transparent; font-size:12px;"

                                       value="<?php if ($rest['supplierAmount'] > 0) {
                        ...
                        <td>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" min="0" class="form-control" name="paidAmount" id="paidAmount"

                                       onkeyup="calculatepaidAmt();" onchange="calculatepaidAmt();"

                                       style=" text-align:center; background-color:transparent; font-size:12px;"

                                       value="<?php echo $rest['paidAmount']; ?>" max="<?php echo $netCost; ?>"/>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" min="0" class="form-control" name="pendingAmount" id="pendingAmount"
    ...
    <div class="col-xl-6">
        ...
        <div class="card">
            ...
            <div class="card-body" style="height: 400px;">
                ...
                <p class="text-muted font-weight-medium mt-1 mb-2"><i class="fa fa-file-text" aria-hidden="true"></i>

                    Today's Payment Collection </p>
                        ...
                        while ($paymentlist = mysqli_fetch_array($a)) {
                            ...
                            <tr style="font-size:12px;">
                                ...
                                <td align="left" valign="top"><a
                                            ...
                                            target="_blank"><?php echo encode($paymentlist['queryId']); ?></a></td>

                                <td align="left"

                                    valign="top"><?php echo stripslashes($clientData['firstName']); ?><?php echo stripslashes($clientData['lastName']); ?></td>

                                <td align="left" valign="top">&#8377;<?php echo($paymentlist['amount']); ?></td>

                                <td align="left"

                                    valign="top"><?php echo date('d/m/Y - h:i A', strtotime($paymentlist['paymentDate'])); ?> </td>
...
<?php if ($_REQUEST['action'] == 'sendpaymentlink') {
    ...
    if (!$_REQUEST['qid']) {
        ...
        $_REQUEST['qid'] = encode($result['queryId']);

        $_REQUEST['pid'] = encode($result['packageId']);
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input name="name" type="text" class="form-control reqfield" id="name"
                               ...
                               value="<?php echo stripslashes($data['name']); ?>" required="">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select id="category" name="category" class="select2 form-control reqfield" autocomplete="off"
                            ...
                            <option value="1" <?php if ('1' == $data['category']) { ?>selected="selected" <?php } ?>>1
                            ...
                            <option value="2" <?php if ('2' == $data['category']) { ?>selected="selected" <?php } ?>>2
                            ...
                            <option value="3" <?php if ('3' == $data['category']) { ?>selected="selected" <?php } ?>>3
                            ...
                            <option value="4" <?php if ('4' == $data['category']) { ?>selected="selected" <?php } ?>>4
                            ...
                            <option value="5" <?php if ('5' == $data['category']) { ?>selected="selected" <?php } ?>>5
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"
                               ...
                               value="<?php echo getCityName($data['destination']); ?>" autocomplete="off">

                        <input name="destination" id="pickupCityfromCity" type="hidden"

                               value="<?php echo stripslashes($data['destination']); ?>"/>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="details" rows="6"
                                  ...
                                  class="form-control"><?php echo stripslashes($data['details']); ?></textarea>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="contactPerson"
                               ...
                               value="<?php echo strip($data['contactPerson']); ?>" autocomplete="off">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="contactPersonEmail"
                               ...
                               value="<?php echo strip($data['contactPersonEmail']); ?>" autocomplete="off">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="contactPersonPhone"
                               ...
                               value="<?php echo strip($data['contactPersonPhone']); ?>" autocomplete="off">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" class="form-control" autocomplete="off">
                            ...
                            <option value="1" <?php if ('1' == $data['status']) { ?>selected="selected" <?php } ?>>
                            ...
                            <option value="0" <?php if ('0' == $data['status']) { ?>selected="selected" <?php } ?>>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="imgLink"
                               ...
                               value="<?php echo strip($data['imgLink']); ?>" autocomplete="off">
            ...
            <div class="row">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td width="10%"><input name="startDate" id="startDate" type="text" class="form-control"

                                               readonly="readonly" value="<?php if ($data['startDate'] != '') {

                                echo date('d-m-Y', strtotime($data['startDate']));

                            } ?>"></td>

                        <td width="10%"><input name="endDate" id="endDate" type="text" class="form-control"

                                               readonly="readonly" value="<?php if ($data['endDate'] != '') {

                                echo date('d-m-Y', strtotime($data['endDate']));

                            } ?>"></td>

                        <td width="12%"><select id="roomType" name="roomType" class="select2 form-control"
                                ...
                                while ($rest = mysqli_fetch_array($rs)) {
                                    ...
                                    <option value="<?php echo $rest['id']; ?>"
                                            ...
                                            <?php if ($rest['id'] == $data['roomType']) { ?>selected="selected" <?php } ?>><?php echo $rest['name']; ?></option>
                        ...
                        <td width="8%"><select id="mealPlan" name="mealPlan" class="select2 form-control"
                                ...
                                while ($rest = mysqli_fetch_array($rs)) {
                                    ...
                                    <option value="<?php echo $rest['id']; ?>"
                                            ...
                                            <?php if ($rest['id'] == $data['mealPlan']) { ?>selected="selected" <?php } ?>><?php echo $rest['name']; ?></option>
                        ...
                        <td width="10%"><input name="single" type="text" class="form-control"

                                               value="<?php echo $data['single']; ?>"></td>

                        <td width="10%"><input name="double" type="text" class="form-control"

                                               value="<?php echo $data['doublePrice']; ?>"></td>

                        <td width="10%"><input name="triple" type="text" class="form-control"

                                               value="<?php echo $data['triple']; ?>"></td>

                        <td width="10%"><input name="quad" type="text" class="form-control"

                                               value="<?php echo $data['quad']; ?>"></td>

                        <td width="10%"><input name="childBed" type="text" class="form-control"

                                               value="<?php echo $data['childBed']; ?>"></td>

                        <td width="5%"><input name="extraAdult" type="text" class="form-control"

                                              value="<?php echo $data['extraAdult']; ?>"></td>

                        <td width="5%"><input name="Save" type="submit"

                                              value="<?php if ($_REQUEST['editid'] != '') { ?>Save<?php } else { ?>Add<?php } ?>"
    ...
    <table class="table table-hover mb-0">
        ...
        while ($rest = mysqli_fetch_array($rs)) {
            ...
            <tr <?php if (decode($_REQUEST['editid']) == $rest['id']) { ?>style="background-color:#FFFFCC" <?php } ?>>
                ...
                <td> <?php if (decode($_REQUEST['editid']) != $rest['id']) { ?>
                        ...
                        <div class="dropdown-menu" style="">
                            ...
                            <a class="dropdown-item"
                               ...
                               onclick="$('#popcontent').load('loadpopup.php?action=addHotelRate&id=<?php echo $_REQUEST['id']; ?>&editid=<?php echo encode($rest['id']); ?>');"

                               style="cursor:pointer;">Edit Rate</a>
            ...
            <div class="row">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td width="10%" class="sic"><input name="adult" type="number" class="form-control"

                                                           value="<?php echo $data['adult']; ?>"></td>

                        <td width="10%" class="sic"><input name="child" type="number" class="form-control"

                                                           value="<?php echo $data['child']; ?>"></td>

                        <td width="10%" class="pvt" style="display:none;"><input name="vehicleCost" type="number"

                                                                                 class="form-control"

                                                                                 value="<?php echo $data['vehicleCost']; ?>">
                ...
                <td> <?php if (decode($_REQUEST['editid']) != $rest['id']) { ?>
                        ...
                        <div class="dropdown-menu" style="">
                            ...
                            <a class="dropdown-item"
                               ...
                               onclick="$('#popcontent').load('loadpopup.php?action=addActivityRate&id=<?php echo $_REQUEST['id']; ?>&editid=<?php echo encode($rest['id']); ?>');"
            ...
            <div class="row">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td width="12%"><select id="transferType" name="transferType" class="select2 form-control"

                                                autocomplete="off" style="width:100%;" onchange="checktype();">

                                <option value="1" <?php if ($data['transferType'] == 1) { ?> selected="selected" <?php } ?>>

                                    SIC

                                </option>

                                <option value="2" <?php if ($data['transferType'] == 2) { ?> selected="selected" <?php } ?>>
                ...
                <td> <?php if (decode($_REQUEST['editid']) != $rest['id']) { ?>
                        ...
                        <div class="dropdown-menu" style="">
                            ...
                            <a class="dropdown-item"
                               ...
                               onclick="$('#popcontent').load('loadpopup.php?action=addtransferRate&id=<?php echo $_REQUEST['id']; ?>&editid=<?php echo encode($rest['id']); ?>');"
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="description"
                               ...
                               value="<?php echo stripslashes($result['description']); ?>">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" class="form-control" onchange="funpaid();">
                            ...
                            <option value="0" <?php if ($result['status'] == 0) { ?>selected="selected" <?php } ?>>
...
<?php if ($_REQUEST['action'] == 'viewtemplate' && $_REQUEST['id'] != '') {
    ...
    <div style="padding:10px 0px; border-bottom:1px solid #ddd; font-size:16px;">
        ...
        <strong>Name:</strong> <?php echo stripslashes($result['name']); ?></div>

    <div style="padding:10px 0px; border-bottom:1px solid #ddd; font-size:16px; margin-bottom:30px;"><strong>Email

            Subject: </strong><?php echo stripslashes($result['subject']); ?></div>
...
<?php if ($_REQUEST['action'] == 'viewcampaign' && $_REQUEST['id'] != '') {
    ...
    <div style="margin-bottom:5px; padding-bottom:5px; border-bottom:1px solid #ddd; ">
        ...
        <strong>Campaign: </strong><?php echo stripslashes($result['title']); ?> (<?php echo encode($result['id']); ?>)

    </div>

    <div style="margin-bottom:5px; padding-bottom:5px; border-bottom:1px solid #ddd; "><strong>Mailing

            Group: </strong><?php echo stripslashes($cgroupdata['name']); ?></div>

    <div style="margin-bottom:5px; padding-bottom:5px; border-bottom:1px solid #ddd; "><strong>Template

            Name: </strong><?php echo stripslashes($templatedata['name']); ?></div>

    <div style="margin-bottom:5px; padding-bottom:5px;border-bottom:1px solid #ddd;">

        <strong>By: </strong><?php echo getUserNameNew($result['addedBy']); ?>

        (<?php echo displaydateindatetme($result['dateAdded']); ?>)

    </div>

    <div style="margin-bottom:5px; padding-bottom:5px;border-bottom:1px solid #ddd;"><strong>Mail

            From: </strong><?php echo stripslashes($result['fromName']); ?>

        < <?php echo stripslashes($result['fromEmail']); ?>>

    </div>

    <div style="margin-bottom:10px; padding-bottom:5px;   "><strong>Mail
...
<?php if ($_REQUEST['action'] == 'exportitinerary' && $_REQUEST['pid'] != '') { ?>
    ...
    <div style="padding:20px;">
        ...
        <a href="<?php echo $fullurl; ?>tcpdf/pdf/download-package.php?pageurl=<?php echo $fullurl; ?>downloadpackagepdf.php?id=<?php echo $_REQUEST['pid']; ?>"

           target="_blank"

           style="padding: 20px; font-size: 22px; font-weight: 700; display: block; margin-bottom: 10px; border: 2px dashed #8CFFDF; background-color: #EAFFFD; text-align: center; color: #333333; text-align: center; border-radius: 5px;"><i

                    class="fa fa-image"></i> Export With Images</a>



        <a href="https://v2.api2pdf.com/chrome/pdf/url?url=<?php echo $fullurl; ?>downloadpackagepdf_withimage2.php?id=<?php echo $_REQUEST['pid']; ?>&apikey=e196cd2c-d5d2-467b-b99b-3ad60f24c20e"

           target="_blank"

           style="padding: 20px; font-size: 22px; font-weight: 700; display: block; margin-bottom: 10px; border: 2px dashed #8CFFDF; background-color: #EAFFFD; text-align: center; color: #333333; text-align: center; border-radius: 5px;"><i

                    class="fa fa-image"></i> Export With Images Option 2</a>



        <a href="https://v2.api2pdf.com/chrome/pdf/url?url=<?php echo $fullurl; ?>downloadpackagepdf_withimage3.php?id=<?php echo $_REQUEST['pid']; ?>&apikey=e196cd2c-d5d2-467b-b99b-3ad60f24c20e"

           target="_blank"

           style="padding: 20px; font-size: 22px; font-weight: 700; display: block; margin-bottom: 10px; border: 2px dashed #8CFFDF; background-color: #EAFFFD; text-align: center; color: #333333; text-align: center; border-radius: 5px;"><i

                    class="fa fa-image"></i> Export With Images Option 3</a>





        <a href="<?php echo $fullurl; ?>downloadpackagepdf_noimage.php?id=<?php echo $_REQUEST['pid']; ?>"

           target="_blank"

           style="padding: 20px; font-size: 22px; font-weight: 700; display: block; margin-bottom: 10px; border: 2px dashed #ff8c8c; background-color: #ffeaea; text-align: center; color: #333333; text-align: center; border-radius: 5px;"><i

                    class="fa fa-download"></i> Export Without Images</a>





        <a href="<?php echo $fullurl; ?>downloadpackagepdf_noimage_four_option.php?id=<?php echo $_REQUEST['pid']; ?>"

           target="_blank"

           style="padding: 20px; font-size: 22px; font-weight: 700; display: block; margin-bottom: 10px; border: 2px dashed #ff8c8c; background-color: #ffeaea; text-align: center; color: #333333; text-align: center; border-radius: 5px;"><i

                    class="fa fa-download"></i> Export With Images Option 4</a>
...
<?php if ($_REQUEST['action'] == 'selectpackage') { ?>
    ...
    <div style="padding:10px;">
        ...
        <input name="searchpackagekeyword" id="searchpackagekeyword" type="text"

               style="padding:15px; border:1px solid #ddd; font-size:16px; width:100%; box-sizing:border-box;"

               placeholder="Search Package" onkeyup="loadselectpackages();"/>
...
<?php if ($_REQUEST['action'] == 'addsignature') {
    ...
    <form class="custom-validation" action="frmaction.html" target="actoinfrm" novalidate="" method="post"
        ...
        <div style="padding:10px;">
            ...
            <textarea class="form-control summernote" id="emailsignature" name="emailsignature" rows="6"

                      placeholder=""><?php echo strip($result['emailsignature']); ?></textarea>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input name="destinationName" type="text" class="form-control reqfield" id="destinationName"

                               value="<?php echo stripslashes($data['destinationName']); ?>" required="">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" rows="5" class="form-control reqfield" id="description"

                                  required=""><?php echo stripslashes($data['description']); ?></textarea>
...
<?php if($_REQUEST['action'] == 'addotpreportpgenerate'){
    ...
    <form class="custom-validation" action="frmaction.html" target="actoinfrm" novalidate="" method="post"
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <label for="validationCustom02">Enter verification code: <?php if($_REQUEST['unverify']){ ?>0000<?php } ?>

                        </label>

                        <input name="otptext" type="text" class="form-control reqfield" id="otptext"
        ...
        <input name="action" type="hidden" id="action" value="addotpreportpgenerate"/>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <select id="destinationId" name="destinationId" class="select2 form-control" autocomplete="off"
                            ...
                            while ($rest = mysqli_fetch_array($rs)) {
                                ...
                                <option value="<?php echo $rest['id']; ?>"
                                        ...
                                        <?php if ($rest['id'] == $data['destinationId']) { ?>selected="selected" <?php } ?>><?php echo $rest['name']; ?></option>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" rows="10" class="form-control"
                                  ...
                                  id="description"><?php echo stripslashes($data['description']); ?></textarea>
...
<?php if ($_REQUEST['action'] == 'addcompanyexpense') {
    ...
    <form class="custom-validation" action="frmaction.html" target="actoinfrm" novalidate="" method="post"
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="paymentType" id="paymentType" class="form-control">
                            ...
                            while ($rest = mysqli_fetch_array($rs)) {
                                ...
                                <option value="<?php echo stripslashes($rest['id']); ?>"

                                        <?php if ($result['paymentType'] == $rest['id']) { ?>selected="selected" <?php } ?>><?php echo stripslashes($rest['name']); ?></option>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" required="" name="startDate" id="expenseDate"
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" id="paymentStatus" class="form-control" onchange="funpaid();">
                            ...
                            if ($result['paymentStatus'] == 2) { ?>selected="selected" <?php }
                                    ...
                                    } else { ?>selected="selected" <?php } ?>>Pending
        ...
        <div class="modal-footer">
            ...
            <input name="Cancel" type="button" value="Cancel" data-dismiss="modal" aria-label="Close"
        ...
        <div class="modal-body" style="padding-top:0px;">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div style="border: 1px solid #ffde9a; background-color: #fffbd5; padding: 10px; margin-bottom: 18px;margin-top: -10px;">

                        System will send auto mail with selected itinerary on change event with query stage according to

                        selected start and end date to client travel date.
                        ...
                        <select name="queryStatus" id="queryStatus" class="form-control">
                            ...
                            while ($rest = mysqli_fetch_array($rs)) {
                                ...
                                <option value="<?php echo stripslashes($rest['id']); ?>"
                                        ...
                                        <?php if ($result['queryStatus'] == $rest['id']) { ?>selected="selected" <?php } ?>><?php echo stripslashes($rest['name']); ?></option>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"
                               ...
                               value="<?php echo getCityName($result['destinationId']); ?>" autocomplete="off">

                        <input name="destinationId" id="pickupCity" type="hidden"

                               value="<?php echo stripslashes($result['destinationId']); ?>"/>
                        ...
                        <select name="packageId" id="packageId" class="form-control">
                            ...
                            while ($rest = mysqli_fetch_array($rs)) {
                                ...
                                <option value="<?php echo stripslashes($rest['id']); ?>"
                                        ...
                                        <?php if ($result['packageId'] == $rest['id']) { ?>selected="selected" <?php } ?>><?php echo stripslashes($rest['name']); ?>

                                    (<?php echo encode($rest['id']); ?>)
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control redborder" id="endDateend" name="endDate" readonly=""
                               ...
                               placeholder="To" value="<?php if ($endDate != '1970-01-01' && $endDate != '01-01-1970') {
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="details" cols="" rows="4" class="form-control"

                                  placeholder="This message will show on itinerary"><?php echo stripslashes($result['details']); ?></textarea>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control reqfield" required="" name="destinations"

                               value="<?php echo stripslashes($result['destinations']); ?>"

                               placeholder="Enter comma seprated destination">
                    ...
                    <div class="form-group">
                        ...
                        <select name="branchId" id="branchId" class="form-control" onchange="showbranches();">
                            ...
                            while ($rest = mysqli_fetch_array($rs)) {
                                ...
                                <option value="<?php echo trim($rest['id']); ?>"

                                        <?php if ($result['branchId'] == trim($rest['id'])) { ?>selected="selected" <?php } ?>><?php echo stripslashes($rest['name']); ?></option>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <select name="parentId" id="parentId" class="form-control">
                            ...
                            <option value="0" <?php if ($result['parentId'] == 0) { ?>selected="selected" <?php } ?>>No
                            ...
                            if ($_REQUEST['id'] != '') {
                                ...
                                while ($rest = mysqli_fetch_array($rs)) {
                                    ...
                                    <option value="<?php echo trim($rest['id']); ?>"
                                            ...
                                            <?php if ($result['parentId'] == trim($rest['id'])) { ?>selected="selected" <?php } ?>><?php echo stripslashes($rest['name']); ?></option>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input name="payment_pricing" type="number" min="0" class="form-control"
                               ...
                               value="<?php echo $result['amount']; ?>" <?php if ($result['status'] == 'sent' || $result['status'] == 'paid') {
...
<?php if ($_REQUEST['action'] == 'schedulebreak' && $_REQUEST['userid'] != '') {
    ...
    <form class="custom-validation" action="frmaction.html" target="actoinfrm" novalidate="" method="post"
        ...
        <div class="modal-body">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="breaktime" value="" placeholder="Input number as minutues" id="breaktime"
        ...
        <input name="activitytype" type="hidden" id="activitytype" value=""/>

    </form>

    <script>

        $('#activitytype').val($('#activityType').val());
...
<?php if ($_REQUEST['action'] == 'loginhourspopup') {
    ...
    ?>
        ...
        <?php
            ...
            $where='id="'.$_REQUEST['userid'].'" and email="'.$_REQUEST['username'].'"';

            $rs=GetPageRecord($select,'sys_userMaster',$where);

            $userLogin=mysqli_fetch_array($rs);
        ...
        <div class="modal-body">
            ...
            <div class="col-md-12">
                    ...
                    <p id="breaktime">Hello, welcome <?php echo $userLogin['firstName'];?>.</p>
...
<?php if ($_REQUEST['action'] == 'logoffhourspopup') {

?>
<div class="modal-body">
    <div class="col-md-12">
        <?php
        // $a=GetPageRecord('cLogin','userLogs',' checkoutTime is null and  userId="'.$_REQUEST['userid'].'" and date(cLogin)="'.date('Y-m-d').'"');
        // $rest=mysqli_fetch_array($a);

        // $break_time = GetPageRecord('SUM(minutes) as totalBreakMinutes', 'useractivities', 'activity_type="1" and user_id="' . $_SESSION['userid'] . '" and date(add_date)="' . date('Y-m-d') . '"');
        // $break_rest=mysqli_fetch_array($break_time);

        // $loginMin = strtotime(date('Y-m-d H:i:s')) - strtotime($rest['cLogin']);

        // $total_minutes = ($loginMin/60) - $break_rest['totalBreakMinutes'];
        // $hours = sprintf("%02d",intdiv($total_minutes, 60)).':'. sprintf("%02d",($total_minutes % 60));
        ?>
        <p style="font-size: 18px;"><strong >Total working hours<strong>, <span class="TotalWorkingTime"></span>.</p>
    </div>
</div>
<div class="modal-footer" style=" position:relative;">
    <a href="logout.html" id="logoutbtn" class="btn btn-primary"><i class="fa fa-sign-out" aria-hidden="true"></i> &nbsp;YES</a>
    <a href="#" id="logoutbtn" class="btn btn-danger" onclick="closeLogout()"><i class="fa fa-sign-out" aria-hidden="true"></i> &nbsp;NO</a>
</div>
<script>
...
<?php if ($_REQUEST['action'] == 'addcitymapping') {?>
    ...
    <form class="custom-validation" action="frmaction.html" target="actoinfrm" novalidate="" method="post"
        ...
        <input name="action" type="hidden" id="action" value="addcitymapping"/>
