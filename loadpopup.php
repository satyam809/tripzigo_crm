...
<?php if ($_REQUEST['action'] == 'logoffhourspopup') {
    ...
    <div class="modal-body">
        <div class="col-md-12">
            <?php
            $a=GetPageRecord('SUM(totalMinutes) as totalMinutes','userLogs',' checkoutTime is not null and  userId="'.$_REQUEST['userid'].'" and date(cLogin)="'.date('Y-m-d').'"');
            ...
            ?>
            <p id="breaktime" style="font-size: 18px;"><strong >Total working hours<strong>, <?php echo $hours; ?>.</p>
        </div>
    </div>
    <div class="modal-footer" style=" position:relative;">
