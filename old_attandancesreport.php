                                    ...
                                    <table border="1" bordercolor="#CCCCCC" class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            while ($res = mysqli_fetch_array($rs[0])) {
                                                ...
                                                $total_working = 0;
                                                //print_r(mysqli_fetch_array($rst));die;
                                                while ($restattand = mysqli_fetch_array($rst)) {
                                                    if ($firstlogin == '') {
                                                        $firstlogin = $restattand['cLogin'];
                                                    }
                                                    if ($restattand['checkoutTime'] != '') {
                                                        $end_time = strtotime($restattand['checkoutTime']);
                                                        $start_time = strtotime($restattand['cLogin']);
                                                        $working_time = $end_time - $start_time;
                                                        $total_working = $total_working + $working_time;
                                                    } else {
                                                        $start_time = strtotime($restattand['cLogin']);
                                                ...
                                                //echo "total_working" . $total_working;
                                                ...
                                                $total_login_minutes = $total_working / 60;
                                                $total_working_minutes = $total_login_minutes - $break_rest['totalBreakMinutes'];
                                                ...
                                                if ($total_working_minutes > 0) {
                                                    $hours = sprintf("%02d", intdiv($total_working_minutes, 60)) . ':' . sprintf("%02d", ($total_working_minutes % 60));
                                                } else {
                                                    $hours = '00:00';
                                                }
                                        ...
                                        <table border="1" bordercolor="#CCCCCC" class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                while ($res = mysqli_fetch_array($rs[0])) {
                                                    ...
                                                    $total_working = 0;
                                                    $restattand = mysqli_fetch_array($rst);
                                                    //print_r($restattand);die;
                                                    while ($restattand = mysqli_fetch_array($rst)) {
