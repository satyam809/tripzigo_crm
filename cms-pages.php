                ...
                <div class="page-content">
                    ...
                    <!-- start page title -->
						...
						<div class="card" style="min-height:500px;">
                            <div class="card-body"> 
                                    <h4 class="card-title cardtitle cardtitle" >CMS Pages
								  ...
								  <input name="page" type="hidden" value="<?php echo $_REQUEST['page']; ?>" />
								   ...
								   <a href="display.html?ga=<?php echo $_REQUEST['ga']; ?>&add=1"><button type="button" class="btn btn-secondary btn-lg waves-effect waves-light" >Add Page</button></a>
									</div></h4> 
...
$rs=GetRecordList('*','cmsPages','  '.$where.'  ','25',$page,$targetpage);
...
<tr>
  ...
  <td width="15%"><?php echo ($rest['url']); ?></td>
  <td width="10%"><?php echo ($rest['pageType']); ?></td>
...
<?php $totalno++; } ?>
									 ...
									 <?php if($totalno==1){ ?>
						   <div style="text-align:center; padding:40px 0px; font-size:14px; color:#999999;">No Page Found </div>
						   <?php } else { ?>
