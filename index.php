...
// users can login only on one device by single account except admin 
//$checkUserSessionRow = GetPageRecord1('*', 'active_sessions', 'user_id="' . $_SESSION['userid'] . '" and date(login_time)="' . date('Y-m-d') . '"');
//echo $checkUserSessionRow; exit;
// if ($_SESSION['userid'] == '' || $_SESSION['username'] == '' || $checkUserSessionRow == 0) {
