                                    ...
                                    <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    <td width="2%">
                                                        <div class="bulbblue"><?php echo substr($rest['firstName'], 0, 1); ?></div>
                                                    </td>
                                                    <td><?php echo stripslashes($rest['firstName']); ?> <?php echo stripslashes($rest['lastName']); ?></td>
                                                    <td><?php echo stripslashes($rest['email']); ?></td>
                                                    <td><?php echo stripslashes($rest['phone']); ?></td>
                                                    <td>
                                                        <?php if ($rest['id'] == 1) {
                                                            echo 'Administrator';
                                                        } else { ?>
                                                            <strong><?php echo stripslashes($restrole['name']); ?></strong> - <?php echo stripslashes($restbranch['name']);
                                                                                                                            } ?>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td><?php if ($rest['id'] != 1) { ?><a href="display.html?ga=team&add=1&id=<?php echo encode($rest['id']); ?>" class="badge badge-info" style="color:#fff !important;">Set Target</a><?php } ?></td>
                                                    <td><?php if ($rest['userType'] != 0) { ?><div class="">
                                                                ...
                                                                <div class="dropdown-menu" style="">
                                                                    <a class="dropdown-item" style="cursor:pointer;" onclick="loadpop('Edit user details',this,'600px')" data-toggle="modal" data-target=".bs-example-modal-center" popaction="action=addstaff&id=<?php echo encode($rest['id']); ?>">Edit User</a>
                                                                </div>
                                                            </div><?php } ?></td>
                                                </tr>
