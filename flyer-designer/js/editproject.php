...
<div class="instagramposts" id="designarea" style=" width:<?php echo $res['pageWidth']; ?>; height:<?php echo $res['pageHeight']; ?>;"> 
 <div class="box" onclick="thisprop(this);" id="ob1" data-id="1"> <img src="images/test.jpg" /></div>
...
d1.insertAdjacentHTML('beforeend', '<div class="box" onclick="thisprop(this);" id="ob'+randomnumber+'" data-id="'+randomnumber+'" style="left: var(--left-2); top: var(--top-2); z-index: var(--zi-2); width: var(--width-2); height: var(--height-2); background-color: var(--bg-2);"> <img src="flyer_library/'+img+'" /></div>');
