...
switch ($_SERVER['REQUEST_METHOD']) {
    case 'GET':
        ...
        if(isset($_GET['package_id']) && trim($_GET['package_id'])!=""){
            ...
            $data_query = "select i.id,i.name,i.description, i.coverPhoto as cover_image, i.startDate as start_date, i.endDate as end_date, i.days as duration, i.adult, i.child, i.destinations, i.location, i.notes, i.hotel as star_rating, i.hotel, i.grossNoGSTPrice as total_price, i.grossPrice as gross_price, i.totaligst + i.totalsgst + i.totalcgst as gst_amount, i.grosstcs as tcs_amount, i.totalDiscount as discount, i.destination_type, i.tour_type, i.activity_type, i.landscape_type, i.dateAdded  from sys_packageBuilder i where i.publicly_visible=1 and queryId=0 and archiveThis=0 and i.id=".$_GET['package_id']." ";
            ...
            $query_flug=0;
            $data_query = "select distinct i.id,i.name,i.description, i.coverPhoto as cover_image, i.startDate as start_date, i.endDate as end_date, i.days as duration, i.adult, i.child, i.destinations, i.location, i.notes, i.hotel as star_rating, i.hotel, i.grossNoGSTPrice as total_price, i.grossPrice as gross_price, i.totaligst + i.totalsgst + i.totalcgst as gst_amount, i.grosstcs as tcs_amount, i.totalDiscount as discount, i.destination_type, i.tour_type, i.activity_type, i.landscape_type, i.dateAdded  from sys_packageBuilder i ";
            if(isset($_GET['q']) && trim($_GET['q'])!=""){
                $data_query .= ",Taggings ts, Tags t ";
            }
            $data_query .= "where 1 and i.publicly_visible=1 and queryId=0 and archiveThis=0 ";
