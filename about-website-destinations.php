...
<div class="main-content">
                ...
                <div class="page-content">
                    ...
                    <!-- start page title -->
						...
						<div class="card">
                            <div class="card-body"> 
                                    <h4 class="card-title cardtitle"  >About Destinations
								 ...
								 <button type="button" class="btn btn-secondary btn-lg waves-effect waves-light"  onclick="loadpop2('Add About Destination',this,'600px')" data-toggle="modal" data-target="#myModal2" data-backdrop="static" popaction="action=addwebsiteaboutdestination">Add About Destination</button>
									</div></h4>
